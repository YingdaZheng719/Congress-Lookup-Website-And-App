angular.
    module('jointCommitteesTable').
    component('jointCommitteesTable', {
        templateUrl: 'joint-committees-table/joint-committees-table.template.html',
        controller: ['$scope', '$http', 'mySharedService', 
            function JointCommitteesTableController($scope, $http, mySharedService) {
                ...
                function getResultsPage() {
                   ...
                   $http.get('http://104.198.0.197:8080/committees?apikey=c79690decb8142c78f0a5e463dfecdf0&chamber=joint&per_page=all')
