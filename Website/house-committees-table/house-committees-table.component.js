angular.
    module('houseCommitteesTable').
    component('houseCommitteesTable', {
        templateUrl: 'house-committees-table/house-committees-table.template.html',
        controller: ['$scope', '$http', 'mySharedService', 
            function HouseCommitteesTableController($scope, $http, mySharedService) {
                ...
                function getResultsPage() {
                   ...
                   $http.get('http://104.198.0.197:8080/committees?apikey=c79690decb8142c78f0a5e463dfecdf0&chamber=house&per_page=all')
